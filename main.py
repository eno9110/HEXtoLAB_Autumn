...
# === Streamlit UI ===
st.title("L* a* b* 色空間の3D可視化とCSV出力_Autumn")

# === HEXカラーリスト（指定された色_Autumn） ===
hex_colors = [
    "#f2e9d8", "#b29a77", "#b49152", "#6a6439", "#804d39",
    "#6a372a", "#774036", "#ffd877", "#fec428", "#eda319",
    "#f0841a", "#b6500b", "#bc3815", "#ffab62", "#fe7c58",
    "#fe5e00", "#f64726", "#da1300", "#cf232b", "#579e0c",
    "#9ce159", "#6a9b35", "#859963", "#54715f", "#4d7028",
    "#395916", "#468d5f", "#08a4a2", "#185358", "#3b5aa7"
]
...
# === CSVファイルに保存 ===
csv_filename = 'hex_to_lab_colors_autumn.csv'
df.to_csv(csv_filename, index=False)

# === CSVダウンロードボタン ===
st.write("### HEXカラーとL* a* b* 座標のCSV出力_autumn")
st.download_button(
    label="CSVをダウンロード",
...
# === Streamlitで3Dグラフ表示 ===
st.write("### L* a* b* 色空間 3D可視化_autumn")
st.plotly_chart(fig)
